...
\node[act, below=0.5cm of s]      (init)   {The ball appears at the start of the level};
\node[act, below=0.5cm of init]   (play)   {The player rolls and jumps the ball, collecting coins for points and grabbing power ups};
\node[dec, below=0.65cm of play]  (lost)   {Fell into a kill zone with no lives left?};
\node[dec, below=0.75cm of lost]  (clear)  {Reached the finish with all the coins?};
