...
\node[act, below=0.5cm of s]      (init)   {The fox and four bears appear in the maze};
\node[act, below=0.5cm of init]   (play)   {The player moves the fox, eating fruit for points. Eating a blueberry scares the bears for a few seconds.};
\node[dec, below=0.65cm of play]  (lost)   {Caught by a bear with no lives left?};
\node[dec, below=0.7cm of lost]   (clear)  {Ate all the raspberries?};
